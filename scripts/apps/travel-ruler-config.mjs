...
export class TravelRulerActorConfig extends HandlebarsApplicationMixin(ApplicationV2) {
	constructor(options = {}) {
		super(options);
	...
	static async #resetDefaults(_ev, _target) {
		const confirmed = await DialogV2.confirm({
			...
			content: "<p>Limpar a lista de atores configurados? O sistema voltará a usar <b>todos os personagens</b>.</p>"
		});
		if (!confirmed) return;
